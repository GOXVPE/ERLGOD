...
function onClickPlayButton() {
  ...
  // add Grange button
  const elementGrangeButton = document.createElement('button');
  elementGrangeButton.id = "grangeButton";
  elementGrangeButton.innerHTML = "Чето делает";
  playerDiv.appendChild(elementGrangeButton);
  elementGrangeButton.addEventListener ("click", function() {
